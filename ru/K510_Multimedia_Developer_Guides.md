...
| inframes | Введите количество кадров yuv | 0 | [0,50] | jpeg、avc |
...
| buf_type | Буфер v4l2`类型` <br>1: V4L2_MEMORY_MMAP: для -vcodec копия<br>2: V4L2_MEMORY_USERPTR: для -vcodec libk510_h264 | 1 | 1~2 |
